...
public class MaximalMinimumValuePathI {
	...
	public void reachTarget(int[][] matrix, int row, int col, 
			int trgtRow, int trgtCol, int minValueTillNow) {
		...
		//reachTarget(matrix, row+1, col+1, trgtRow, trgtCol, minValueTillNow);
	}
	...
	public static void main(String[] args) {
		int[][] matrix = {{9, 1},{1, 2}};//  {{7, 5, 3},{2, 0, 9},{4, 5, 9}};//{{0, 1},{0, 2},{1, 3},{2, 3},{2, 5},{5, 6},{3, 4}};
